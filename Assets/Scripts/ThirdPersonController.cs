    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (_input.jump && _jumpTimeoutDelta <= 0.0f )//&& !_paused) //change here pause
                {
        ...
        {
            if (other.collider.CompareTag("JumpPad"))
            {
                JumpHeight = 15f;
            }
            else
        ...
        public void KillPlayer()
        {
            ...
            AudioSource.PlayClipAtPoint(DeadAudioClip, transform.position, DeadAudioVolume);
